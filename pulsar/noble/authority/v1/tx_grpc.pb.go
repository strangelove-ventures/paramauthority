...
func (c *msgClient) ExecuteLegacyContent(ctx context.Context, in *MsgExecuteLegacyContent, opts ...grpc.CallOption) (*MsgExecuteLegacyContentResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_ExecuteLegacyContent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) ExecuteLegacyContent(context.Context, *MsgExecuteLegacyContent) (*MsgExecuteLegacyContentResponse, error) {
...
func _Msg_ExecuteLegacyContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_ExecuteLegacyContent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
