...
func init() {
	proto.RegisterType((*QueryAuthority)(nil), "noble.authority.v1.QueryAuthority")
	proto.RegisterType((*QueryAuthorityResponse)(nil), "noble.authority.v1.QueryAuthorityResponse")
}
...
var fileDescriptor_fe44ac131dc0ca31 = []byte{
	...
	,
}
...
func (c *queryClient) Authority(ctx context.Context, in *QueryAuthority, opts ...grpc.CallOption) (*QueryAuthorityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/noble.authority.v1.Query/Authority", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Authority_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/noble.authority.v1.Query/Authority",
	}
