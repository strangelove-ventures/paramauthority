...
var (
	pattern_Query_Authority_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"noble", "authority", "v1", "address"}, "", runtime.AssumeColonVerbOpt(true)))
)
