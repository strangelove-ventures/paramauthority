...
import (
	...
	"github.com/noble-assets/paramauthority/simapp"
...
func main() {
	...
	if err := serverCmd.Execute(rootCmd, "", simapp.DefaultNodeHome); err != nil {
...
func NewRootCmd() *cobra.Command {
	tempApp := simapp.NewSimApp(log.NewNopLogger(), cmtDb.NewMemDB(), nil, true, sims.NewAppOptionsWithFlagHome(simapp.DefaultNodeHome))
	...
	rootCmd.AddCommand(
		config.Cmd(),
		debug.Cmd(),
		genUtilCmd.GenesisCoreCommand(encodingConfig.TxConfig, simapp.ModuleBasics, simapp.DefaultNodeHome),
		genUtilCmd.InitCmd(simapp.ModuleBasics, simapp.DefaultNodeHome),
