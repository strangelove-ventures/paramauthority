module github.com/noble-assets/paramauthority/tests
...
require (
	...
	github.com/noble-assets/paramauthority v1.0.0
...
replace (
	// use strangelove's replaces for ChainSafe/go-schnorrkel
	github.com/ChainSafe/go-schnorrkel => github.com/ChainSafe/go-schnorrkel v0.0.0-20200405005733-88cbf1b4c40d
	github.com/ChainSafe/go-schnorrkel/1 => github.com/ChainSafe/go-schnorrkel v1.0.0
	// cosmos flavoured protobuf
	github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1
	// use local version of authority module
	github.com/noble-assets/paramauthority => ./..
	// use local version of interchaintest
